...
const Resorts = () => {
  ...
  // Filter data based on category + search term
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-center mb-6">
          <div className="flex items-center bg-white border border-gray-200 rounded-full shadow-sm px-5 py-3 w-full max-w-2xl gap-3 focus-within:ring-2 focus-within:ring-blue-400 transition">
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 rounded-full transition-all duration-200 ${
                      isActive ? "w-6 bg-blue-600 opacity-100" : "w-0 opacity-0"
                    }`}
                  />
                </button>
              );
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-500">
            ...
            {searchTerm && (
              <span className="text-gray-700 font-medium"> for "{searchTerm}"</span>
            )}
            {selectedCategory !== "All" && (
              <span className="text-gray-700 font-medium"> in {selectedCategory}</span>
            )}
          </p>
        </div>
        ...
        {filteredData.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-700 mb-1">No resorts found</h3>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-1 mt-10">
            ...
            <button
              ...
              className="px-3 py-2 rounded-lg border border-gray-200 text-sm font-semibold text-gray-600 hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed transition"
            >
              ‹
            </button>
