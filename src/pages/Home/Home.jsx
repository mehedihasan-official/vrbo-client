    ...
    <div className="container mx-auto ">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center text-gray-700 px-2 md:px-4 max-w-6xl mx-auto text-sm md:text-base lg:text-lg my-8 md:my-12">
        ...
        <p className="leading-relaxed">
          As a <span className="font-semibold text-blue-600">One Key</span>{" "}
          member, you can save 10% or more on over 100,000 hotels worldwide.
        </p>
      </div>
            ...
            <div className="text-gray-600 space-y-3 md:space-y-4 text-sm md:text-base">
              <div>
                <p className="font-semibold text-gray-800">
                  The perfect vacation rental awaits
                </p>
                <p className="mt-1">
                  Beachfront villas, city apartments or mountain cabins —
                  whatever, wherever your heart desires.
                </p>
              </div>
              <div>
                <p className="font-semibold text-gray-800">
                ...
                <p className="mt-1">
                  Rent an entire home for half the price of a hotel. Then add
                  the savings of not always eating out at restaurants.
                </p>
              </div>
              <div>
                <p className="font-semibold text-gray-800">
                ...
                <p className="mt-1">
                  Kick back and relax. Everything you need is at your fingertips
                  — the comforts of spacious living, privacy and fully-stocked
                  kitchens.
                </p>
              </div>
            </div>
          ...
          <div className="p-4 md:p-6">
            ...
            <div className="text-gray-600 space-y-3 md:space-y-4 text-sm md:text-base">
              <div>
                ...
                <p className="mt-1">
                  Choose from rentals in all the best parts of town — near the
                  office or your favorite park and a morning run.
                </p>
              </div>
              <div>
                <p className="font-semibold text-gray-800">Amenities</p>
                <p className="mt-1">
                  Wi-Fi and work spaces make it business as usual, yet
                  comfortable and relaxed in your own place.
                </p>
              </div>
              <div>
                <p className="font-semibold text-gray-800">Value</p>
                <p className="mt-1">
                  Stretch your travel dollar with lower nightly rates and
                  home-cooked meals just the way you like them.
                </p>
              </div>
            </div>
          </div>
